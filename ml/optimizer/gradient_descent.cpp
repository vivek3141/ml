...
vector<double> _optimize(PyObject* func, double learning_rate, int steps, vector<double> init_theta,
...
static PyObject * optimize(PyObject* self, PyObject* args)
{
	...
	vector<double> ret_theta = _optimize(func, learning_rate, steps, theta, dx, num_theta);
	//printf("\n");
