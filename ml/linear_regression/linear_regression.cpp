...
vector<double> _fit(vector<double> x, vector<double> label, vector<double> init_theta, int steps, double lr, int n)
{
...
static PyObject * fit(PyObject* self, PyObject* args)
{
	...
	vector<double> ret_theta = _fit(x, y, theta, steps, lr, m);
